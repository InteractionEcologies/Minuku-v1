...
public class MobileMainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = MobileMainActivity.this;
        ...
        if (!MinukuMainService.isServiceRunning()) {
            ...
            intent.setClass(MobileMainActivity.this, MinukuMainService.class);
    ...
    public void setFragment() {
        ...
        ((ProfileFragment) fragment).setAdultCaptions();
